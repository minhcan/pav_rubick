...
<?php if ($layout == 'layout_1') { ?>
	<div class="panel <?php echo $addition_cls;?>">
		<?php if( $show_title ) { ?>
		<div class="col-lg-3 col-md-3 panel-heading style2">
		...
		<div class="col-lg-9 col-md-9 list box-products panel-body  owl-carousel-play  <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>" id="product_list<?php echo $id;?>" data-ride="owlcarousel">
