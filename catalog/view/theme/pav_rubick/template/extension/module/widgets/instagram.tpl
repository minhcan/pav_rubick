		...
		<div class="box-products owl-carousel-play" id="instagram-<?php echo $id;?>" data-ride="owlcarousel">
		    ...
		    <?php if( $show_title ) { ?>
				<div class="widget-heading panel-heading">		
					...
					<p class="desciption-title"><?php echo strip_tags(html_entity_decode($title_description, ENT_QUOTES, 'UTF-8')); ?></p>
					<?php } ?>
				</div>
			<?php } ?>
			...
			<div class="carousel-controls-v1">
				<a class="carousel-control carousel-sm left" href="#instagram-<?php echo $id;?>"   data-slide="prev">
					<i class="fa fa-chevron-left"></i>
				</a>
				<a class="right carousel-control carousel-sm" href="#instagram-<?php echo $id;?>"  data-slide="next">
