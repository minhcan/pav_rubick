            ...
            <div id="product">
              ...
              <div class="product-buttons-wrap clearfix">
                    ...
                    <div class="action">
                        ...
                        <button class="compare" type="button" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>;');"><i class="icon-bag"></i></button>
                        <button class="wishlist" type="button" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>;');"><i class="fa fa-star"></i></button>
                    </div>
                </div>
