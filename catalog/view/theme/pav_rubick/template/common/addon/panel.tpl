			...
			<div class="panelinner">
				...
				<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="post" class="clearfix"><div class="clearfix">
					...
					<p class="group-input pull-right">
						...
						<a class="btn btn-primary " href="<?php echo HTTP_SERVER; ?>?pavreset=?"><span>Reset</span></a>
					</p>
				</div></form>
			</div>
		</div>
				                            ...
				                            <div class="accordion-inner panel-body clearfix">
				                              	<?php foreach ($group['selector'] as $item ) {  ?>
													 <?php  if (isset($item['type'])&&$item['type']=="image") { ?>
					                                  ...
					                                  <div class="form-group">
															<label><?php echo $item['label']?></label>
															<input value="" size="10" name="customize[<?php echo $group['match']?>][]" data-match="<?php echo $group['match']?>" type="text" class="input-setting" data-selector="<?php echo $item['selector']?>" data-attrs="<?php echo $item['attrs']?>"><a href="#" class="clear-bg btn btn-primary "><i class="fa fa-times"></i></a>
													  </div>
					                                  <?php } ?>
