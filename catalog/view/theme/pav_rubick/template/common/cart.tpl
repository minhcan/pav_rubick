<div id="cart" class="btn-group btn-block">
    <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="dropdown-toggle">
        <i class="icon-bag"></i>      
        <span id="cart-total"><?php echo substr($text_items, 0, strpos($text_items, ' ')+1); ?></span>
          <?php $res = explode("-", $text_items);?>
    </button>
  <ul class="dropdown-menu pull-right table-responsive">
        ...
        <li>
          <div>
            ...
            <p class="text-right"><a class="btn btn-primary btn-sm" href="<?php echo $cart; ?>"><strong> <?php echo $text_cart; ?></strong></a>&nbsp;&nbsp;&nbsp;<a class="btn btn-primary btn-sm" href="<?php echo $checkout; ?>"><strong><?php echo $text_checkout; ?></strong></a></p>
          </div>
        </li>
        <?php } else { ?>
        <li>
