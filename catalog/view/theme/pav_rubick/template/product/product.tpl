...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
            ...
            <div id="product">
              ...
              <hr>
                <div class="product-buttons-wrap clearfix">
                    ...
                    <hr>
                    <div class="action">
                        <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="pull-left btn"><i class="fa fa-shopping-basket"></i><?php echo $button_cart; ?></button>
                        <button class="compare" type="button" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>;');"><i class="icon-bag"></i></button>
                        <button class="wishlist" type="button" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>;');"><i class="fa fa-star"></i></button>
                    </div>
                </div>
              ...
              <!-- AddThis Button BEGIN -->
                ...
                <?php if ($tags) { ?>
                <hr>
                  <p class="margin-bottom-20"><?php echo $text_tags; ?>
                    <?php for ($i = 0; $i < count($tags); $i++) { ?>
                    <?php if ($i < (count($tags) - 1)) { ?>
                    <a class="text-primary" href="<?php echo $tags[$i]['href']; ?>"><?php echo $tags[$i]['tag']; ?></a>,
                    <?php } else { ?>
                    <a class="text-primary" href="<?php echo $tags[$i]['href']; ?>"><?php echo $tags[$i]['tag']; ?></a>
                    <?php } ?>
                    <?php } ?>
             ...
             <?php require( ThemeControlHelper::getLayoutPath( 'product/info/default.tpl' ) );  ?>
    ...
    <?php if ($products) {  $heading_title = $text_related; ?>
      <div class="panel panel-v1 product-related"> <?php require( ThemeControlHelper::getLayoutPath( 'common/products_carousel.tpl' ) );  ?>   </div>
    <?php } ?>
</div>
