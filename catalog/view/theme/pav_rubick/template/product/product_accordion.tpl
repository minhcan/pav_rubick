          ...
          <div id="product">
            ...
            <div class="product-buttons-wrap">
              ...
              <div class="action clearfix">
                  <div class="pull-left">
                      <a data-toggle="tooltip" class="wishlist" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa-fw fa fa-heart"></i><?php echo $button_wishlist; ?></a>
                  </div>
                  <div class="pull-left">
                      <a data-toggle="tooltip" class="compare" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa-fw fa fa-refresh"></i><?php echo $button_compare; ?></a>
                  </div>
              </div>
            </div>
            <?php if ($minimum > 1) { ?>
