...
class ControllerExtensionModulePavtestimonial extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			if( isset($this->request->get['module_id']) ) {
				$this->response->redirect($this->url->link('extension/module/pavtestimonial', 'module_id='.$this->request->get['module_id'].'&token=' . $this->session->data['token'], 'SSL'));
			}else{
				$this->response->redirect($this->url->link('extension/module/pavtestimonial', 'token=' . $this->session->data['token'], 'SSL'));
			}
		}
		...
		$this->data['action'] = $this->url->link('extension/module/pavtestimonial', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->get['module_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
			...
			$this->data['action'] = $this->url->link('extension/module/pavtestimonial', 'module_id='.$this->request->get['module_id'].'&token=' . $this->session->data['token'], 'SSL');
		}else {
			$d = $d;
		...
		$this->response->setOutput($this->load->view('extension/module/pavtestimonial.tpl', $this->data));
	}
	...
	public function _breadcrumbs(){
		$this->data['breadcrumbs'] = array();
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/pavtestimonial', 'token=' . $this->session->data['token'], 'SSL'),
      		'separator' => ' :: '
   		);
	}
